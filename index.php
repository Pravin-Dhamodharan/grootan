...
<html>
 ...
 <body>
  <div class="container">
   <br />
   <h3 align="center">CSV File Importing in Database</h3>
   <br />
   <form id="upload_csv" method="post" enctype="multipart/form-data">
                <div class="column">  
                    <center><input type="file" name="csv_file" id="csv_file" accept=".csv" style="margin-top:15px;" /></center>
                </div>  
                <div class="column">  
                    <center><input type="submit" name="upload" id="upload" value="Upload" style="margin-top:10px;" class="btn btn-info btn btn-danger" /></center>
                </div>  
